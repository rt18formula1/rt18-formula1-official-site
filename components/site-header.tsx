...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-black/10">
      ...
      {menuOpen && (
        <div className="fixed inset-0 top-[73px] z-40 bg-white overflow-y-auto">
          <nav className="container mx-auto px-4 py-8 flex flex-col gap-1">
            ...
            <Link
              href="/admin"
              onClick={closeMenu}
              className="py-3 text-sm font-bold text-gray-400 hover:text-black transition-colors mt-4"
            >
              Admin
            </Link>
          </nav>
